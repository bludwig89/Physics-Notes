...
Build something crazy: a cellular automaton that can do science better than science! (For real though, the idea is to be able to predict or calculate a ton of what we can currently predict and know from current state-of-the-art measurements).
...
Main thing is, science is cool, and maybe the Lord will give me a little understanding and knowledge to figure out something cool. Proverbs 25:2 says *"It is to the glory of God to conceal a matter, and the glory of kings to reveal it."*  Enough said.
...
- See `lattice-vs-spacetime-tests.md` for our current testing from going from a "theoretical" lattice structure to a 
