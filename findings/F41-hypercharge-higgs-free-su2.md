...
3. **The Stueckelberg path (F34b) is unchanged** — extending $U(x)$ to carry one extra U(1)_Y phase costs one additional Goldstone d.o.f., exactly what Stueckelberg eats to give $Z$ its longitudinal mode.
